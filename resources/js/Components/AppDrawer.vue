...
<template>
    <Teleport to="body">
        <div v-show="show" class="fixed inset-0 z-50 flex justify-end" role="dialog" aria-modal="true">
            ...
            >
                <div v-show="show" class="relative w-screen max-w-md bg-white shadow-2xl dark:bg-gray-900 flex flex-col h-full border-l border-gray-100 dark:border-gray-800">
